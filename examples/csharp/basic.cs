...
{
    class BenchmarkRateExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/benchmarkrate";

        /// <summary>
        /// Make a GET request to the Benchmark Rate API
        /// </summary>
        static async Task<JsonDocument> CallBenchmarkRateAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;rate&quot;] &#x3D; &quot;SOFR&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Benchmark Rate API...\n");

            var result = await CallBenchmarkRateAPI();
