// Package benchmarkrate provides a Go client for the Benchmark Rate API.
//
// For more information, visit: https://apiverve.com/marketplace/benchmarkrate?utm_source=go&utm_medium=readme
package benchmarkrate
...
const (
	baseURL        = "https://api.apiverve.com/v1/benchmarkrate"
	defaultTimeout = 30 * time.Second
)

// Client is the Benchmark Rate API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Benchmark Rate API client.
...
// Execute makes a request to the Benchmark Rate API with typed parameters.
//
...
//   - rate (required): string - The benchmark rate to retrieve
