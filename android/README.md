...
```gradle
dependencies {
    implementation 'com.github.apiverve:benchmarkrate-api:1.1.14'
}
```
...
```java
import com.apiverve.benchmarkrate.BenchmarkRateAPIClient;
import com.apiverve.benchmarkrate.APIResponse;
import com.apiverve.benchmarkrate.APIException;

// Initialize the client
BenchmarkRateAPIClient client = new BenchmarkRateAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("rate", "SOFR");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/benchmarkrate](https://docs.apiverve.com/ref/benchmarkrate)
...
- **Documentation:** [https://docs.apiverve.com/ref/benchmarkrate](https://docs.apiverve.com/ref/benchmarkrate)
- **Issues:** [GitHub Issues](https://github.com/apiverve/benchmarkrate-api/issues)
