...
namespace APIVerve.API.BenchmarkRate
{
    ...
    /// <summary>
    /// Client for the BenchmarkRate API
    /// </summary>
    public class BenchmarkRateAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/benchmarkrate";
        ...
        {
            { "rate", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public BenchmarkRateAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BenchmarkRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BenchmarkRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BenchmarkRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BenchmarkRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(BenchmarkRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BenchmarkRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BenchmarkRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BenchmarkRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BenchmarkRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BenchmarkRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BenchmarkRateQueryOptions options)
        {
