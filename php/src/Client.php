...
namespace APIVerve\Benchmarkrate;
...
/**
 * Client for the Benchmark Rate API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://benchmarkrate.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/benchmarkrate';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BenchmarkrateClient] {$message}\n";
        }
    }
}
